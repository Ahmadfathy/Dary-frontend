...
// Hardcoded dummy data for the revenue chart
const dummySalesData: number[] = [
  58, 64, 52, 45, 42, 38, 45, 53, 56, 65, 75, 85,
];

const dummyRentalData: number[] = [
  12, 14, 15, 12, 11, 13, 15, 18, 20, 22, 25, 28,
];
